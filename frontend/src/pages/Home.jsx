        ...
        {[
          {
            name: "instagram",
            svg: (
              <Link to={'https://www.instagram.com/rainbowriserealty/'} target='_blank' class="group transition-all duration-500 hover:-translate-y-2">
              <svg
          ...
          },
          {
            name: "linkedin",
            svg: (
              <Link to={'https://www.linkedin.com/in/rainbow-rise-realty-8641a1333'} target='_blank' class="group transition-all duration-500 hover:-translate-y-2">
              <svg
