    ...
    <Link to={ type==="project" ? '/project/'+data?.id : '/properties/'+data?.id }>
        <div className=" mx-auto p-1 md:p-4 ">
            <div className="flex flex-col bg-[#F8FAFC] shadow-lg rounded-lg overflow-hidden">
                {/* Left Section */}
                <div class="h-28 lg:h-64 flex flex-col">
                ...
                <div className="">
                    ...
                    <div className="p-4">
                        ...
                        <h3 className="text-sm md:text-3xl font-bold mt-2 line-clamp-1">{data.title}</h3>
                        ...
                        <div className="flex flex-col justify-center">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
                                ...
                                <div className="flex items-center p-1 md:p-2">
                                    <Building className="text-green-500 mr-1 w-4" />
                                    <p className="text-xs md:text-sm">{data.category}</p>
                                </div>

                                {/* BHK */}
                                <div className="flex items-center p-1 md:p-2">
                                    <Bed className="text-purple-500 mr-1 w-4" />
                                    <p className="text-xs md:text-sm">{data.rooms}</p>
                                </div>

                                {/* Area Size */}
                                <div className="flex items-center p-1 md:p-2">
                                    <Ruler className="text-red-500 mr-1 w-4" />
                                    <p className="text-xs md:text-sm">{data.area_size}</p>
                                </div>
                            </div>
                        </div>
